...
<header class="navbar navbar-fixed-top bg-light">
  ...
  <ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
      <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="<c:url value="/resources/admin/assets/img/avatars/1.jpg" />" alt="avatar" class="mw30 br64 mr15">
