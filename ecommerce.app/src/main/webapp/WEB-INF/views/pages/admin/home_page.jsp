...
<head>
  ...
  <meta charset="utf-8">
  <title>Administration - MonPressing</title>
  <meta name="keywords" content="MonPressing, Pressing" />
  <meta name="description" content="is a pressing">
  <meta name="author" content="Mohamed BELMAHI">
  ...
  <!-- Theme CSS -->
  <link rel="stylesheet" type="text/css" href="<c:url value="/resources/admin/assets/skin/default_skin/css/theme.css"/>">

  <!-- Admin Panels CSS -->
  <link rel="stylesheet" type="text/css" href="<c:url value="/resources/admin/assets/admin-tools/admin-plugins/admin-panels/adminpanels.css"/>">

  <!-- Admin Forms CSS -->
  <link rel="stylesheet" type="text/css" href="<c:url value="/resources/admin/assets/admin-tools/admin-forms/css/admin-forms.css"/>">

  <!-- Favicon -->
  <link rel="shortcut icon" href="<c:url value="/resources/admin/assets/img/favicon.ico"/>">
...
--%>
      ...
      <li class="dropdown">
        <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="assets/img/avatars/1.jpg" alt="avatar" class="mw30 br64 mr15">
          <span>${employee.completName}</span>
...
<script type="text/javascript" src="<c:url value="/resources/admin/vendor/plugins/circles/circles.js"/>"></script>
...
<!-- Admin Panels  -->
<script type="text/javascript" src="<c:url value="/resources/admin/assets/admin-tools/admin-plugins/admin-panels/json2.js"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/admin/assets/admin-tools/admin-plugins/admin-panels/jquery.ui.touch-punch.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/admin/assets/admin-tools/admin-plugins/admin-panels/adminpanels.js"/>"></script>

<!-- Page Javascript -->
<script type="text/javascript" src="<c:url value="/resources/admin/assets/js/pages/widgets.js"/>"></script>
