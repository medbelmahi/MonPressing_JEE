...
<head>
    ...
    <meta charset="utf-8">
    <title>Administration - Mon pressing</title>
...
<body class="external-page sb-l-c sb-r-c">
            ...
            <section id="content">
                ...
                <div class="admin-form theme-info" id="login1">
                    ...
                    <div class="row mb15 table-layout">
                        ...
                        <div class="col-xs-6 va-m pln">
                            <a href="dashboard.html" title="Return to Dashboard">
                                <img src="<c:url value="/resources/admin/assets/img/logos/logo_white.png" />" title="AdminDesigns Logo" class="img-responsive w250">
                            </a>
                        </div>

                        <div class="col-xs-6 text-right va-b pr5">
                            <div class="login-links">
                                <a href="<c:url value="/admin/login" />" class="active" title="Sign In">Se connecter</a>
                    ...
                    <div class="panel panel-info mt10 br-n">
                        ...
                        <form method="post" action="<c:url value='/admin/j_spring_security_check' />" id="contact">
                                    ...
                                    <div class="col-sm-7 pr30">
                                        ...
                                        <div class="section">
                                            ...
                                            <label for="username" class="field prepend-icon">
                                                <input type="text" name="email" id="username" class="gui-input" placeholder="Entrez votre e-mail">
    ...
    <!-- Page Plugins -->
    <script type="text/javascript" src="<c:url value="/resources/admin/assets/js/pages/login/EasePack.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/admin/assets/js/pages/login/rAF.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/admin/assets/js/pages/login/TweenLite.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/admin/assets/js/pages/login/login.js" />"></script>
